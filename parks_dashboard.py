...
def create_report():
    ...
    with arcpy.EnvManager(
            scratchWorkspace=r"T:\work\giss\monthly\202211nov\gallaga\parks dashboard\parks_dashboard_aprx\Default.gdb",
            workspace=r"T:\work\giss\monthly\202211nov\gallaga\parks dashboard\parks_dashboard_aprx\Default.gdb"):
    ...
    with arcpy.EnvManager(
            ...
            workspace=r"T:\work\giss\monthly\202211nov\gallaga\parks dashboard\parks_dashboard_aprx\Default.gdb"):
        output_1_6_ = \
        arcpy.management.CalculateField(in_table=output_1_3_, field="Maintenance_Filter", expression="cf(!MAINTBY!)",
    ...
    with arcpy.EnvManager(
            ...
            workspace=r"T:\work\giss\monthly\202211nov\gallaga\parks dashboard\parks_dashboard_aprx\Default.gdb"):
        asset_name_join2_3_ = \
        arcpy.management.CalculateField(in_table=output_1_6_, field="Primary_Use_Filter", expression="cf(!PRIMARY!)",
                                        expression_type="PYTHON3", code_block="""def cf(a):
    if a is None:
        return 'No'
    elif a == 'N':
...
def SequentialNumber(a):
    ...
    if dissed_3_:
        with arcpy.EnvManager(outputMFlag="Enabled",
                              scratchWorkspace=r"T:\work\giss\monthly\202211nov\gallaga\parks dashboard\parks_dashboard_aprx\Default.gdb",
                              workspace=r"T:\work\giss\monthly\202211nov\gallaga\parks dashboard\parks_dashboard_aprx\Default.gdb"):
    ...
    if dissed_3_:
        with arcpy.EnvManager(
                ...
                workspace=r"T:\work\giss\monthly\202211nov\gallaga\parks dashboard\parks_dashboard_aprx\Default.gdb"):
            Dissolve2_4_ = \
            arcpy.management.AlterField(in_table=Dissolve2_2_, field="LAND_ID", new_field_name="Land ID 2",
...
def cf(a,b):
    ...
    if dissed_3_:
        with arcpy.EnvManager(
                scratchWorkspace=r"T:\work\giss\monthly\202211nov\gallaga\parks dashboard\parks_dashboard_aprx\Default.gdb",
                workspace=r"T:\work\giss\monthly\202211nov\gallaga\parks dashboard\parks_dashboard_aprx\Default.gdb"):
            Updated_Input_Table_2_ = \
            arcpy.management.AddField(in_table=final_output_final_output_4_, field_name="MAINRECUSE", field_type="TEXT",
                                      field_precision=None, field_scale=None, field_length=None,
